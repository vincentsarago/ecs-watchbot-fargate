...
module.exports = (options = {}) => {
  ...
  Resources[prefixed('Task')] = {
    ...
    Properties: {
      ...
      ExecutionRoleArn: cf.join(['arn:aws:iam::', cf.accountId, ':role/ecsTaskExecutionRole']),
...
if (options.securityGroups)
    Resources[prefixed('Service')].Properties.NetworkConfiguration.securityGroups = options.securityGroups;
