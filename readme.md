[![Build Status](https://travis-ci.org/vincentsarago/ecs-watchbot-fargate.svg?branch=master)](https://travis-ci.org/vincentsarago/ecs-watchbot-fargate)

#### :warning: This is a modified clone from https://github.com/mapbox/ecs-watchbot to make it work with AWS Fargate.
